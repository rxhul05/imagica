...
const styles = StyleSheet.create({
    ...
    list: { padding: 20 },
    card: { flexDirection: 'row', backgroundColor: Colors.surface, borderRadius: 12, marginBottom: 16, padding: 12, borderWidth: 1, borderColor: Colors.lightGray },
    image: { width: 100, height: 100, borderRadius: 8, backgroundColor: Colors.gray },
    ...
    addToCartBtn: { backgroundColor: Colors.primary, paddingHorizontal: 16, paddingVertical: 8, borderRadius: 20 },
    ...
    shopBtn: { marginTop: 16, paddingVertical: 12, paddingHorizontal: 24, backgroundColor: Colors.primary, borderRadius: 24 },
